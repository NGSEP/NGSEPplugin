...
import net.sf.ngsep.view.MainVCFIntrogressionAnalysis;
 ...
 *
 */
public class PlugVCFIntrogressionAnalysis extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (firstElement instanceof IFile) {
			...
			//Create main window
			MainVCFIntrogressionAnalysis window = new MainVCFIntrogressionAnalysis();
