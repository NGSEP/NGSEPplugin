...
import net.sf.ngsep.view.MainAlleleSharingStatistics;

/**
 * @author Juan Fernando De la Hoz
 *
 */
public class PlugAlleleSharingStatistics extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (firstElement instanceof IFile){
			...
			//Create main window
			MainAlleleSharingStatistics view = new MainAlleleSharingStatistics();
