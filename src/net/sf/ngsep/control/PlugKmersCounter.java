...
import net.sf.ngsep.view.MainKmersCounter;
 ...
 *
 */
public class PlugKmersCounter extends AbstractHandler {
    ...
    public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (firstElement instanceof IFile) {
			...
			//Create main window
			MainKmersCounter window = new MainKmersCounter();
		    ...
		    MessageDialog.openInformation(shell, "Info","Please select a Fastq/FASTA file");
		}
