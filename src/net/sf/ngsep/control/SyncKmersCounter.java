...
/**
 * Creation and execution of Kmers Counter process
 * @author Cristian Loaiza
 *
 */
public class SyncKmersCounter extends Job {
	
	//Instance of the model class with the optional parameters already set
	private KmersCounter instance;
	 ...
	 */
	public SyncKmersCounter(String name) {
		super(name);
	}
	...
	protected IStatus run(IProgressMonitor monitor) {
		...
		try {
			...
			log.info("Error Calculating k-mers counter: ");
	...
	public void setInstance(KmersCounter instance) {
