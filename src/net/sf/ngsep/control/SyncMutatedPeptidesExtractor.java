 ...
 */
public class SyncMutatedPeptidesExtractor extends Job {
	...
	private MutatedPeptidesExtractor instance;
	
	public SyncMutatedPeptidesExtractor(String name) {
		super(name);
	}
	...
	protected IStatus run(IProgressMonitor monitor) {
		...
		try {
			...
			instance.loadTranscriptome(transcriptomeMap,genome);
			out = new PrintStream(outputFile);
			instance.findMutatedPeptides(variantsFile, out);
	 ...
	 * @return the instance
	 */
	public MutatedPeptidesExtractor getInstance() {
		return instance;
	}
	 ...
	 */
	public void setInstance(MutatedPeptidesExtractor instance) {
