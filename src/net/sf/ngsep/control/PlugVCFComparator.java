...
import net.sf.ngsep.view.MainVCFComparator;
 ...
 *
 */
public class PlugVCFComparator extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		//String selectedFile;
		MainVCFComparator compareVCF;
		if (firstElement instanceof IFile) {
			IFile inputFile = (IFile) firstElement;
			String selectedFile = inputFile.getLocation().toString();
			try {
				compareVCF = new MainVCFComparator(); 
				compareVCF.setSelectedFile(selectedFile);
				compareVCF.open(); 
			} catch (Exception e) {
				e.printStackTrace();
			}
