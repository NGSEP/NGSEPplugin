...
import net.sf.ngsep.view.MainCalculateCoverageStatistics;
 ...
 *
 */
public class PlugCoverageStatistics extends AbstractHandler {
	...
	// Address SAM
	String resAli;
	MainCalculateCoverageStatistics window;
	if (firstElement instanceof IFile) {
	    try {
		inputFile = (IFile) firstElement;
		resAli = inputFile.getLocation().toString();
		window = new MainCalculateCoverageStatistics();
